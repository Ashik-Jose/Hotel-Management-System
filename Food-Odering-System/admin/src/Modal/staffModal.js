...
const Modal = ({ isVisible, onClose }) => {
    ...
    return (
        <div className="main-card">
            <form>
                <h1 className="heading">ADD NEW STAFF</h1>
                <div className="form-group">
                    <label className="form-label">Employee ID </label>
                    <input className="form-control" type="text" value={data.emp_id} onChange={(e)=>{setData({...data,emp_id:e.target.value})}}/>
                </div>
                <div className="form-group">
                ...
                <div className="button-group">
                    ...
                    <button className="btn2" type="buttom" onClick={()=>{
                        ...
                        API.post('/insertemployeedetails',data).then((response) => {
